...
function section2() {
  ...
  console.log("student yan ih", student_name.value);
}
...
async function save() {
  ...
  await fetch(`http://127.0.0.1:8000/save/`, {
    ...
    body: JSON.stringify({
      ...
      has_medical_illness: illness_button.value,
      diseases: illnesses.value,
      food: food.value,
      no_known_allergies: no_known_allergies.value,
      medicines: medicines.value,
      cigarette: cig_selected.value,
      alcohol: alc_selected.value,
    }),
  });
}
